...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IIADDQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ };     # Add IIADDQ
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIADDQ, IIRMOVQ, IRMMOVQ, IMRMOVQ };           # Add IIADDQ

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ,
              IIADDQ, IJXX, ICALL };                        # Add IIADDQ
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IIADDQ, IPUSHQ, IRET, IPOPQ } : E_valB;            # Add IIADDQ
...
bool set_cc = E_icode in { IOPQ, IIADDQ } &&                    # Add IIADDQ
