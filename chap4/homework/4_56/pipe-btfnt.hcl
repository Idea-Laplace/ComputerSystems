...
word f_pc = [
    ...
    # Branch taken but acutally should not have been taken
	M_icode == IJXX && M_ifun != UNCOND && !M_Cnd && M_valE < M_valA : M_valA;
    # Branch not taken but acutally should have been taken
...
word f_predPC = [
    ...
    f_icode == IJXX && f_ifun != UNCOND && f_valC < f_valP : f_valC;            # Custom combinational logic
	1 : f_valP;
];
